...
describe NumberGame do
  ...
  describe '#game_over?' do
    ...
    context 'when user guess is not correct' do
      subject(:incorrect_guess) { described_class.new(5, '9')}
      # remove the 'x' before running this test
  ...
  describe '#player_turn' do
    ...
    context 'when user inputs two incorrect values, then a valid input' do
      before do
        ...
        invalid_input_2 = 'd'
        valid_input = '3'
        allow(game_loop).to receive(:player_input).and_return(invalid_input_1, invalid_input_2, valid_input)
      end
  ...
  describe '#final_message' do
    ...
    context 'when count is 4 and over' do
      # remove the 'x' before running this test
      subject(:long_game) { described_class.new(5, '5', 4)}
      it 'outputs correct phrase' do
        bummer_phrase = "That was hard. It took you 4 guesses!\n"
        expect { long_game.final_message }.to output(bummer_phrase).to_stdout
      end
    end
  end
end
